...
ENABLE="--enable-pthreads --enable-shared --enable-nonfree -enable-libpulse  --enable-librtmp --enable-version3 --enable-libass --enable-libfdk-aac --enable-libx265 --enable-libvpx --enable-libx264 --enable-libmp3lame --enable-libopenh264 --enable-openssl --enable-libspeex  --enable-libopencore-amrnb --enable-libopencore-amrwb --enable-gpl --enable-runtime-cpudetect --enable-libopenh264 --enable-encoder=libopenh264 --enable-encoder=aac --enable-encoder=mjpeg --enable-decoder=h264 --enable-decoder=aac --enable-decoder=mjpeg --enable-parser=h264 --enable-parser=aac --enable-parser=mjpeg --enable-muxer=mp4 --enable-muxer=rtsp --enable-muxer=mjpeg --enable-demuxer=mov --enable-demuxer=rtsp --enable-demuxer=mjpeg --enable-protocol=file --enable-protocol=http --enable-protocol=rtp --enable-protocol=rtmp"
